...
#include "res/NotoSans-Regular.ttf.res.inc"
...
void Application::RegisterBuiltinData() {
	...
	dataFS->AddFile("font.ttf", FileData::NewStatic(reinterpret_cast<std::byte *>(src_res_NotoSans_Regular_ttf_res_inc_data), src_res_NotoSans_Regular_ttf_res_inc_size));
